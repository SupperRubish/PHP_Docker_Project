    ...
    <?php
        ...
        if(isset($_POST['ADDCAR'])){
            ...
            if($result2==1&&$result4==1){
                ...
                $sql5="INSERT INTO Log (U_ID,Username,Page,Action,Time) VALUES ($userid,'$Username','$Page','Add new car $Vehicle_licence for $People_licence','$currentDateTime');";
                $result5 = mysqli_query($conn, $sql5);
                $logFile = '../Log/file.log';
                $handler = new StreamHandler($logFile, Logger::DEBUG);
                $logger->pushHandler($handler);
                $logger->info('Add new car in addNewCar.php', array('username' => $Username));
                ...
                try{
                    ...
                    if($result2==1){
                        ...
                        if($result4==1&&$result5==1){
                            ...
                            $UID=$_SESSION['userid'];
                            $currentDateTime = date("Y-m-d H:i:s");
                            $sql5="INSERT INTO Log (Username,U_ID,Page,Action,Time) VALUES ('$Username','$UID','$Page','Add new car $Vehicle_licence for $People_licence','$currentDateTime');";
                            $result5 = mysqli_query($conn, $sql5);
                            $logFile = '../Log/file.log';
                            $handler = new StreamHandler($logFile, Logger::DEBUG);
                            $logger->pushHandler($handler);
